from tkinter import *
import json
from difflib import get_close_matches #This module provides classes and functions for comparing sequences.
...
window.title('Advanced Dictionary of English Talking Dictionary')
